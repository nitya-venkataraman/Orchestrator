...
5. **Self-check.** Run `python3 ux-pipeline/validators/synthesis.py <your .json>` and fix every
...
2. Persist `output/discovery/discovery-synthesis-<slug>.json` (pretty-printed) and
   `output/discovery/discovery-synthesis-<slug>.md` (the Research Synthesis Report: per theme —
